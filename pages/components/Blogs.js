...
export default () => {
    ...
    return (
        ...
        <br/>
<center><button 
    className="px-4 items-center py-2 text-lg text-white duration-100 bg-teal-600 hover:teal-800 rounded-md shadow-md focus:shadow-none ring-offset-2 ring-indigo-600 focus:ring-2">
   View More
</button></center>
        </>
    )
